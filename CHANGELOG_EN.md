...
- feat: Support `OAuth2` login, can login via `Github` `Authentik` and other third parties, see details [OAuth2 Third-party Login](https://temp-mail-docs.example.com/en/guide/feature/user-oauth2.html)
...
- fix: imap proxy server doesn't support password by @upstream (#356)
- worker adds `ANNOUNCEMENT` configuration, for configuring announcement info by @upstream (#357)
- fix: telegram bot create new address defaults to first domain by @upstream (#358)
...
Worker configuration file adds `DEFAULT_DOMAINS`, `USER_ROLES`, `USER_DEFAULT_ROLE`, see documentation [worker configuration](https://temp-mail-docs.example.com/en/guide/cli/worker.html)
...
- Add Chinese email alias configuration `DOMAIN_LABELS` [documentation](https://temp-mail-docs.example.com/en/guide/cli/worker.html)
- Remove `mail channels` related code
- github actions adds `FRONTEND_BRANCH` variable to specify deployment branch (#324)

## v0.5.1

- Add `mail-parser-wasm-worker` for worker email parsing, [documentation](https://temp-mail-docs.example.com/en/guide/feature/mail_parser_wasm_worker.html)
...
- Add using `resend` to send emails, `resend` provides http and smtp api, easier to use, documentation: https://temp-mail-docs.example.com/en/guide/config-send-mail.html
...
* feat: telegram bot TelegramSettings && webhook by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/244
* fix build by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/245
* feat: UI changes by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/247
* feat: SMTP IMAP Proxy: add sendbox && UI: sendbox use split view by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/248

## v0.4.2

- Fix some bugs in smtp imap proxy server
- Fix UI interface text errors, interface adds version number
- Add telegram bot documentation https://temp-mail-docs.example.com/en/guide/feature/telegram.html

* fix: imap server by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/227
* fix: Maintenance wrong label by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/229
* feat: add version for frontend && backend by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/230
* feat: add page functions proxy to make response faster by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/234
* feat: add about page by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/235
* feat: remove mailV1Alert && fix mobile showSideMargin by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/236
* feat: telegram bot by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/238
* fix: remove cleanup address due to many table need to be clean by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/240
* feat: docs: Telegram Bot by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/241
* fix: smtp_proxy: cannot decode 8bit && tg bot new random address by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/242
* fix: smtp_proxy: update raise imap4.NoSuchMailbox by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/243
...
* feat: use common function handleListQuery when query by page by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/220
* fix: typos by @lwd-temp in https://github.com/upstream/cloudflare_temp_email/pull/221
* fix: name max 30 && /external/api/send_mail not return result by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/222
* fix: smtp_proxy_server support decode from mail charset by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/223
* feat: add imap proxy server by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/225
* feat: UI show version by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/226

### New Contributors

* @lwd-temp made their first contribution in https://github.com/upstream/cloudflare_temp_email/pull/221
...
* feat: update docs by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/204
* feat: add Deploy to Cloudflare Workers button by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/205
* feat: add Deploy to Cloudflare Workers docs by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/206
* feat: add UserLogin by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/209
* feat: admin search mailbox && fix generateName multi dot && user jwt exp in 30 days && UI globalTabplacement && useSideMargin by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/214
* feat: UI check openSettings in Login page by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/215
* feat: UI move AdminContact to common by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/217
* feat: docs by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/218
...
* feat: UI: MailBox add reply button by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/187
* feat: add cron auto clean up by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/189
* fix: delete account by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/190
...
* feat: support admin create address && add ENABLE_USER_CREATE_EMAIL co… by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/175
* feat: add SMTP proxy server by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/177
* fix: cf ui var is string by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/178
* fix: UI mailbox 100vh to 80vh by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/179
* fix: smtp_proxy_server hostname && add docker image for linux/arm64 by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/180
* fix: some browser do not support wasm by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/182
* feat: add COPYRIGHT by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/183
* feat: UI: add user page: useIframeShowMail && mailboxSplitSize by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/184
* feat: add address_block_list for new address by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/185
...
* feat: remove PREFIX logic in db by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/171
* feat: admin page add account mail count && sendbox default all && sen… by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/172
* feat: all mail use MailBox Component by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/173

**Full Changelog**: https://github.com/upstream/cloudflare_temp_email/compare/0.2.10...v0.3.0
...
* feat: docs update by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/165
* feat: add ENABLE_USER_DELETE_EMAIL && ENABLE_AUTO_REPLY && modify fetchAddressError i18n && UI: show autoRefreshInterval by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/169
...
- feat: allow user delete mail && notify when send access changed by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/132
- feat: request_send_mail_access default 1 balance by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/143
- fix: RATE_LIMITER not call jwt by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/146
- fix: delete_address not delete address_sender by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/153
- fix: send_balance not update when click sendmail by @upstream in https://github.com/upstream/cloudflare_temp_email/pull/155
