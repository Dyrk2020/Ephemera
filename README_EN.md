...
<p align="center">
  <a href="https://temp-mail-docs.example.com" target="_blank">
    <img alt="docs" src="https://img.shields.io/badge/docs-grey?logo=vitepress">
  </a>
  <a href="https://github.com/upstream/cloudflare_temp_email/releases/latest" target="_blank">
    <img src="https://img.shields.io/github/v/release/upstream/cloudflare_temp_email">
  </a>
  <a href="https://github.com/upstream/cloudflare_temp_email/blob/main/LICENSE" target="_blank">
    <img alt="MIT License" src="https://img.shields.io/github/license/upstream/cloudflare_temp_email">
  </a>
  <a href="https://github.com/upstream/cloudflare_temp_email/graphs/contributors" target="_blank">
   <img alt="GitHub contributors" src="https://img.shields.io/github/contributors/upstream/cloudflare_temp_email">
  </a>
  <a href="">
    <img alt="GitHub top language" src="https://img.shields.io/github/languages/top/upstream/cloudflare_temp_email">
  </a>
  <a href="">
    <img src="https://img.shields.io/github/last-commit/upstream/cloudflare_temp_email">
  </a>
</p>
...
[Documentation](https://temp-mail-docs.example.com) | [Github Action Deployment Guide](https://temp-mail-docs.example.com/en/guide/actions/github-action.html)

<a href="https://temp-mail-docs.example.com/en/guide/actions/github-action.html">
...
Try it now → [https://mail.example.com/](https://mail.example.com/)
...
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Backend](https://temp-email-api.example.com/) | [![Deploy Backend Production](https://github.com/upstream/cloudflare_temp_email/actions/workflows/backend_deploy.yaml/badge.svg)](https://github.com/upstream/cloudflare_temp_email/actions/workflows/backend_deploy.yaml) ![](https://uptime.example.com/api/badge/10/status) ![](https://uptime.example.com/api/badge/10/uptime) ![](https://uptime.example.com/api/badge/10/ping) ![](https://uptime.example.com/api/badge/10/avg-response) ![](https://uptime.example.com/api/badge/10/cert-exp) ![](https://uptime.example.com/api/badge/10/response) |
| [Frontend](https://mail.example.com/)          | [![Deploy Frontend](https://github.com/upstream/cloudflare_temp_email/actions/workflows/frontend_deploy.yaml/badge.svg)](https://github.com/upstream/cloudflare_temp_email/actions/workflows/frontend_deploy.yaml) ![](https://uptime.example.com/api/badge/12/status) ![](https://uptime.example.com/api/badge/12/uptime) ![](https://uptime.example.com/api/badge/12/ping) ![](https://uptime.example.com/api/badge/12/avg-response) ![](https://uptime.example.com/api/badge/12/cert-exp) ![](https://uptime.example.com/api/badge/12/response)         |
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=upstream/cloudflare_temp_email&type=Date&theme=dark" />
  <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=upstream/cloudflare_temp_email&type=Date" />
  <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=upstream/cloudflare_temp_email&type=Date" />
</picture>
