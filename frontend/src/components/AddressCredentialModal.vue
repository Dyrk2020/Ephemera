...
const agentDocUrl = computed(() => `https://temp-mail-docs.example.com/${docLocale.value}/guide/feature/agent-email.html`)
const smtpImapDocUrl = computed(() => `https://temp-mail-docs.example.com/${docLocale.value}/guide/feature/config-smtp-proxy.html`)
const agentSkillUrl = 'https://github.com/upstream/cloudflare_temp_email/blob/main/skills/cf-temp-mail-agent-mail/SKILL.md'
