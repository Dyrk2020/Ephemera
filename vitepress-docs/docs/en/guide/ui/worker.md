...
4. Download [worker.js](https://github.com/upstream/cloudflare_temp_email/releases/latest/download/worker.js)
...
5. Go back to `Overview`, find the worker you just created, click `Edit Code`, delete the original file, upload `worker.js`, and click `Deploy`
    ...
    >
    > Reference: [issues156](https://github.com/upstream/cloudflare_temp_email/issues/156#issuecomment-2079453822)
...
6. Click `Settings` -> `Variables and Secrets`, add variables as shown in the image
    ...
    >
    > For `USER_ROLES`, please configure in this format: `[{"domains":["example.com","example.org"],"role":"vip","prefix":"vip"},{"domains":["example.com","example.org"],"role":"admin","prefix":""}]`
