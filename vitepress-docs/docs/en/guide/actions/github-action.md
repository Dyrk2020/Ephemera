...
- Pages frontend `secrets`
   ...
   | `FRONTEND_NAME`    | The project name you created in Cloudflare Pages, can be created via [UI](https://temp-mail-docs.example.com/en/guide/ui/pages.html) or [Command Line](https://temp-mail-docs.example.com/en/guide/cli/pages.html) |
