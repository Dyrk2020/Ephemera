...
npx skills add upstream/cloudflare_temp_email --skill cf-temp-mail-agent-mail
# Add -g to install globally
npx skills add upstream/cloudflare_temp_email --skill cf-temp-mail-agent-mail -g

# Option 2: npx degit to copy into your agent's skills folder
npx degit upstream/cloudflare_temp_email/skills/cf-temp-mail-agent-mail <your-agent-skills-dir>/cf-temp-mail-agent-mail

# Option 3: clone and copy
git clone --depth 1 https://github.com/upstream/cloudflare_temp_email.git /tmp/cf-temp-mail
cp -r /tmp/cf-temp-mail/skills/cf-temp-mail-agent-mail <your-agent-skills-dir>/
```

See [SKILL.md](https://github.com/upstream/cloudflare_temp_email/blob/main/skills/cf-temp-mail-agent-mail/SKILL.md) for details.
