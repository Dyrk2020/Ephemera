...
First, confirm your current version, then visit the [Release page](https://github.com/upstream/cloudflare_temp_email/releases/) and [CHANGELOG page](https://github.com/upstream/cloudflare_temp_email/blob/main/CHANGELOG.md) to find your current version.
