...
export const en = defineConfig({
    ...
    themeConfig: {
        ...
        editLink: {
            pattern: 'https://github.com/upstream/cloudflare_temp_email/edit/main/vitepress-docs/docs/:path',
    ...
    return [
        ...
        },
        {
            ...
            items: [
                {
                    text: 'CHANGELOG',
                    link: 'https://github.com/upstream/cloudflare_temp_email/blob/main/CHANGELOG.md'
                },
                {
                    text: 'Contribute',
