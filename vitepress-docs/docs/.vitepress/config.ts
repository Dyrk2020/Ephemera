...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:image', content: 'https://temp-mail-docs.example.com/logo.png' }],
    ['meta', { property: 'og:url', content: 'https://temp-mail-docs.example.com' }],
    ...
    ['meta', { name: 'twitter:image', content: 'https://temp-mail-docs.example.com/logo.png' }],
    ['link', { rel: 'alternate', hreflang: 'zh-Hans', href: 'https://temp-mail-docs.example.com/zh/' }],
    ['link', { rel: 'alternate', hreflang: 'en', href: 'https://temp-mail-docs.example.com/en/' }],
    ['link', { rel: 'alternate', hreflang: 'x-default', href: 'https://temp-mail-docs.example.com/zh/' }],
  ],
  sitemap: {
    hostname: 'https://temp-mail-docs.example.com',
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      {
        icon: 'github',
        link: 'https://github.com/upstream/cloudflare_temp_email'
      }
    ]
  }
})
