...
- pages 前端 `secrets`
   ...
   | `FRONTEND_NAME`    | 你在 Cloudflare Pages 创建的项目名称，可通过 [用户界面](https://temp-mail-docs.example.com/zh/guide/ui/pages.html) 或者 [命令行](https://temp-mail-docs.example.com/zh/guide/cli/pages.html) 创建 |
