...
首先确认当前的版本，然后访问 [Release 页面](https://github.com/upstream/cloudflare_temp_email/releases/) 和 [CHANGELOG 页面](https://github.com/upstream/cloudflare_temp_email/blob/main/CHANGELOG.md) 中找到当前的版本
